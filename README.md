...
The rationale for this is that rectangular geometries for the layerwise-QG is sufficiently complexl more principled complexity is instead added through a varying subinertial wind
and topography.
